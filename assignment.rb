...
#  has_many :pre_class_assignment, class_name:"Lesson", foreign_key: "pre_class_assignment_id"
#  has_many :in_class_assignment, class_name: "Lesson", foreign_key: "in_class_assignment_id"
  belongs_to :courses
  belongs_to :lessons
